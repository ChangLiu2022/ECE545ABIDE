...
configs = [
    ...
    {"identifier":"A", "seq": "128-182-512", "self": False, "dropout":False, "prefix": "combined_v4_X3_X_"},
    {"identifier":"A", "seq": "128-182-512", "self": True, "dropout":False, "prefix": "combined_v4_X3_X_"},
    #{"identifier":"A", "seq": "128-182-512", "self": False, "dropout":True, "prefix": "combined_v4_X3_X_"},
    #{"identifier":"A", "seq": "128-182-512", "self": True, "dropout":True, "prefix": "combined_v4_X3_X_"}
]
